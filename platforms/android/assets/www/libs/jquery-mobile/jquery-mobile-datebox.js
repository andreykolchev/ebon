...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, { "ru": {
	...
	"titleDateDialogLabel": "Дата",
	"titleTimeDialogLabel": "Время",
	"daysOfWeek": [
		"Воскресенье",
		"Понедельник",
		"Вторник",
	...
	"timeOutput": "%l:%M %p",
	"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
	"calDateListLabel": "Другие",
	"calHeaderFormat": "%B %Y",
	"calTomorrowButtonLabel": "Перейти к след. дате"
}});
jQuery.extend(jQuery.mobile.datebox.prototype.options, {
	useLang: "ru"
});
...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, { "uk": {
	...
	"timeOutput": "%l:%M %p",
	"durationFormat": "%Dd %DA, %Dl:%DM:%DS",
	"calDateListLabel": "Інші",
	"calHeaderFormat": "%B %Y",
	"calTomorrowButtonLabel": "Наст. дата"
}});
jQuery.extend(jQuery.mobile.datebox.prototype.options, {
	useLang: "uk"
});