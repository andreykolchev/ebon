...
public class Orders {
    ...
    public Orders(int id, int order_number, String order_date, String description, int account_id, int model_id, int get_service_location_id, String get_date_time, int put_service_location_id, String put_date_time) {
        this.id = id;
    ...
    public String toJsonString() {
        ...
        if (model_id != 0)
            {if (!(JsonString.equals("")))
            {JsonString = JsonString + ",";}
            JsonString = JsonString + "\"model_id\":" + model_id;}
